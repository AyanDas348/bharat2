                ...
                <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
                    <div className="flex flex-col items-center bg-white">
                        <div className="text-center bg-white">
                            <p className="text-lg font-medium text-gray-600 font-pj bg-white">2,157 people have said how good Rareblocks</p>
                            <h2 className="mt-4 text-3xl font-bold text-gray-900 sm:text-4xl bg-white xl:text-5xl font-pj">Our happy clients say about us</h2>
                        </div>
                        ...
                        <div className="relative mt-10 md:mt-24 md:order-2">
                            ...
                            <div className="relative grid max-w-lg grid-cols-1 gap-6 mx-auto md:max-w-none lg:gap-10 md:grid-cols-3">
                                {/* Testimonial Cards */}
                                {/* You can map through an array of testimonials and create individual components for each */}
                                <TestimonialCard
            ...
            <div className="flex flex-col justify-between flex-1 p-6 bg-white lg:py-8 lg:px-7">
                <div className="flex-1">
                    <div className="flex items-center">
                        {/* The SVGs for rating */}
                        {/* You can replace these with a proper rating component */}
                        {[...Array(5)].map((_, index) => (
                ...
                <div className="flex items-center mt-8">
                    <img className="flex-shrink-0 object-cover rounded-full w-11 h-11" src={avatarUrl} alt="" />
                    <div className="ml-4">
